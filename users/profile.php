...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">First Contact</label>
 <div class="col-sm-4">
<input type="text" name="contactno" required="required" value="<?php echo htmlentities($row['contactno']);?>" class="form-control">
</div>
<label class="col-sm-2 col-sm-2 control-label">Second Contact</label>
 <div class="col-sm-4">
<input type="text" name="contactno" required="required" value="<?php echo htmlentities($row['contactno2']);?>" class="form-control">
</div>
</div>
...
<div class="col-sm-4">
<input type="text" name="country" required="required" value="<?php echo htmlentities($row['icnumber']);?>" class="form-control">
</div>
