...
$remark=$_POST['remark'];
$query=mysqli_query($con,"insert into complaintremark(complaintNumber,status,notetransport,checking,remark) values('$complaintnumber','$status','$notetransport','$checking','$remark')");
